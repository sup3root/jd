...
# 美丽研究院
1 7,12,19 * * *  node /scripts/aaro_jd_beauty.js >> /scripts/logs/aaro_jd_beauty.log 2>&1
# 省钱大赢家之翻翻乐
...
# 东东电竞经理
0 9 * * * node /scripts/aaro_jd_esManager.js >> /scripts/logs/aaro_jd_esManager.log 2>&1
# 零食街
...
# 京小鸽吾悦寄
0 9 * * * node /scripts/aaro_jd_jxg.js >> /scripts/logs/aaro_jd_jxg.log 2>&1
# 京喜领88元红包
...
# 京东试用
0 9 * * * node /scripts/aaro_jd_try.js >> /scripts/logs/aaro_jd_try.log 2>&1
# 取关京东店铺和商品
55 23 * * * node /scripts/aaro_jd_unsubscribe.js >> /scripts/logs/aaro_jd_unsubscribe.log 2>&1
# 众筹许愿池
...
# 京东多合一签到
0 9 * * * node /scripts/jd_bean_sign.js >> /scripts/logs/jd_bean_sign.log 2>&1
# 美丽研究院
...
# 京东抽奖机&内部互助
0 9 * * * node /scripts/jd_lotteryMachine.js >> /scripts/logs/jd_lotteryMachine.log 2>&1
# 幸运大转盘
...
# 送豆得豆
0 9 * * * node /scripts/jd_sendBeans.js >> /scripts/logs/jd_sendBeans.log 2>&1
# 闪购盲盒
...
# 东东电竞经理
 0 0-23/2 * * node /scripts/ling_jd_EsportsManager.js >> /scripts/logs/ling_jd_EsportsManager.log 2>&1
# MM领京豆
...
# 店铺签到
0 9 * * * node /scripts/ling_jd_ShopSign.js >> /scripts/logs/ling_jd_ShopSign.log 2>&1
# 领京豆额外奖励
23 1,12,22 * * * node /scripts/ling_jd_bean_home.js >> /scripts/logs/ling_jd_bean_home.log 2>&1
# 美丽研究院
1 7,12,19 * * *  node /scripts/ling_jd_beauty.js >> /scripts/logs/ling_jd_beauty.log 2>&1
# 省钱大赢家之翻翻乐
...
# 签到领现金兑换
0 9 * * * node /scripts/ling_jd_cash_exchange.js >> /scripts/logs/ling_jd_cash_exchange.log 2>&1
# 领券中心签到
...
# 东东游戏
0 9 * * * node /scripts/ling_jd_ddgame.js >> /scripts/logs/ling_jd_ddgame.log 2>&1
# 东东玩家
0 9 * * * node /scripts/ling_jd_ddwj.js >> /scripts/logs/ling_jd_ddwj.log 2>&1
# 热血心跳,狂解压
0 9 * * * node /scripts/ling_jd_decompression.js >> /scripts/logs/ling_jd_decompression.log 2>&1
# 狂欢欧洲杯
55 59 9  * node /scripts/ling_jd_europeancup.js >> /scripts/logs/ling_jd_europeancup.log 2>&1
# 金榜创造营
...
# 京东众筹好物上新
0 9 * * * node /scripts/ling_jd_hwsx.js >> /scripts/logs/ling_jd_hwsx.log 2>&1
# 京东到家鲜豆任务
...
# 京小鸽吾悦寄
0 9 * * * node /scripts/ling_jd_jxg.js >> /scripts/logs/ling_jd_jxg.log 2>&1
# 柠檬惊喜工厂抢茅台
0 9 * * * node /scripts/ling_jd_jxgc.js >> /scripts/logs/ling_jd_jxgc.log 2>&1
# 京喜领88元红包
...
# 京东抽奖机
0 9 * * * node /scripts/ling_jd_lotteryMachine.js >> /scripts/logs/ling_jd_lotteryMachine.log 2>&1
# 京东零食街
...
# 集魔方
11 10 * * *  node /scripts/ling_jd_mofang.js >> /scripts/logs/ling_jd_mofang.log 2>&1
# 5G超级盲盒
...
# 京东签到图形验证
14 10 * * *  node /scripts/ling_jd_sign_graphics.js >> /scripts/logs/ling_jd_sign_graphics.log 2>&1
# 东东小窝
...
# 明星小店
12 19 10-17 9 *  node /scripts/ling_jd_star_shop.js >> /scripts/logs/ling_jd_star_shop.log 2>&1
# 东东超市
...
# 京东试用
0 9 * * * node /scripts/ling_jd_try.js >> /scripts/logs/ling_jd_try.log 2>&1
# 天天赚京豆
20 8 * * * node /scripts/ling_jd_ttzjd.js >> /scripts/logs/ling_jd_ttzjd.log 2>&1
# 特物Z简爱
0 9 * * * node /scripts/ling_jd_twlove.js >> /scripts/logs/ling_jd_twlove.log 2>&1
# 特务Z行动-星小店
0 9 * * * node /scripts/ling_jd_twz_star.js >> /scripts/logs/ling_jd_twz_star.log 2>&1
# 推一推
0 0 * * * node /scripts/ling_jd_tyt.js >> /scripts/logs/ling_jd_tyt.log 2>&1
# 取关京东店铺和商品
55 23 * * * node /scripts/ling_jd_unsubscribe.js >> /scripts/logs/ling_jd_unsubscribe.log 2>&1
# 京东众筹许愿池
0 9 * * * node /scripts/ling_jd_wish.js >> /scripts/logs/ling_jd_wish.log 2>&1
# 东东世界
0 9 * * * node /scripts/ling_jd_work_ddworld.js >> /scripts/logs/ling_jd_work_ddworld.log 2>&1
# 粉丝互动
34 6,18 * * *  node /scripts/ling_jd_wxFans.js >> /scripts/logs/ling_jd_wxFans.log 2>&1
# 柠檬伊利养牛记
...
# 东东世界
0 9 * * * node /scripts/star_jd_ddworld.js >> /scripts/logs/star_jd_ddworld.log 2>&1
# 热血心跳,狂解压
0 9 * * * node /scripts/star_jd_decompression.js >> /scripts/logs/star_jd_decompression.log 2>&1
# 粉丝互动
34 5,18 * * *  node /scripts/star_jd_fan.js >> /scripts/logs/star_jd_fan.log 2>&1
# 金像奖助力
...
# 特务
23 9 * * *  node /scripts/star_jd_productZ4Brand.js >> /scripts/logs/star_jd_productZ4Brand.log 2>&1
# 明星小店
12 19 19-30 9 *  node /scripts/star_jd_star_shop.js >> /scripts/logs/star_jd_star_shop.log 2>&1
# 古蜀寻宝
12 9,15 1-30 9,10 *  node /scripts/star_jd_xinxiangyin.js >> /scripts/logs/star_jd_xinxiangyin.log 2>&1
# 京东资产变动
0 8,23 * * * node /scripts/zero_jd_bean_change.js >> /scripts/logs/zero_jd_bean_change.log 2>&1
# 领京豆额外奖励
...
# 东东游戏
0 9 * * * node /scripts/zero_jd_ddgame.js >> /scripts/logs/zero_jd_ddgame.log 2>&1
# 东东乐园
...
# 汪汪乐园过新手任务
0 9 * * * node /scripts/zero_jd_joy_park_newtask.js >> /scripts/logs/zero_jd_joy_park_newtask.log 2>&1
# 汪汪乐园每日任务
...
# 惊喜牧场
0 9 * * * node /scripts/zero_jd_jxmc.js >> /scripts/logs/zero_jd_jxmc.log 2>&1
# 京东快递签到
10 0 * * * node /scripts/zero_jd_kd.js >> /scripts/logs/zero_jd_kd.log 2>&1
# 京东直播
50 12-14 * * * node /scripts/zero_jd_live.js >> /scripts/logs/zero_jd_live.log 2>&1
# MM领京豆
...
# 特务
23 9 * * *  node /scripts/zero_jd_superBrand.js >> /scripts/logs/zero_jd_superBrand.log 2>&1
# 东东超市
